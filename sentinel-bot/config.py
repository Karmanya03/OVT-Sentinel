...
class Settings:
    ...
    nvidia_uncensored_model: str = "nvidia/nvidia-nemotron-nano-9b-v2"
...
def load_settings() -> Settings:
    ...
    return Settings(
        ...
        nvidia_uncensored_model=os.getenv("NVIDIA_UNCENSORED_MODEL", "nvidia/nvidia-nemotron-nano-9b-v2"),
