...
| **NVIDIA NIM (Uncensored)** 🔞 | `NVIDIA_API_KEY` | `deepseek-ai/deepseek-v4-flash` | Fallback for unfiltered content | 284B MoE (13B active), 1M context, MIT license, Chinese alignment (permissive on technical/hacking content) |
